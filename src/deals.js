    ...
    <div className='alerts'>
      ...
      <div className="info-container">
          <div className="info-image">
            <img src="	https://autocj.co.jp/images/newimages/howtobuy.png?ver=39" alt="How to Buy" />
          </div>
          <div className="info-content">
            <h2 className="info-header">How to Buy from Japan</h2>
            <p className="info-text">
              How to buy a used car from Japan? Autocom Japan has thousands of stock cars available for your direct purchase.
            </p>
            <button className="info-button">Check</button>
        </div>
</div>
